...
Automated builds of the image are available on [Docker Hub](https://hub.docker.com/r/tiredofit/nginx-php-fpm) and is the recommended method of installation.
...
* `8.0-latest` - PHP 8.0.x w/Alpine Edge
* `7.4-latest` - PHP 7.4.x w/Alpine Edge
